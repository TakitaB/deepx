...
def upload():
    ...
    if request.method =="POST":
        ...
        if form.validate_on_submit():
            ...
            #first check that the model ouput folder is empty and if its not empty it (it too should be a temporary directory that stores
            # only one file, the file that the model generates for the user)

            if len(os.listdir("Model_output")) != 0:
            ...
            #flash message if client tries to upload file that is too big
